...
public:
 ...
 private:
   ...
   QPushButton *LeftChuhuo;//左出货
   QPushButton *RightChuhuo;//右出货
   QPushButton *ForwardChuhuo;//前出货
   QPushButton *BackChuhuo;//后出货

   QPushButton *LeftShouhuo;//左收货
   QPushButton *RightShouhuo;//右收货
   QPushButton *ForwardShouhuo;//前收货
   QPushButton *BackShouhuo;//后收货
...
public slots:
    ...
    void action_LeftChuhuo();//独立测试窗口
    void action_RightChuhuo();//独立测试窗口
    void action_ForwardChuhuo();//独立测试窗口
    void action_BackChuhuo();//独立测试窗口
    void action_LeftShouhuo();//独立测试窗口
    void action_RightShouhuo();//独立测试窗口
    void action_ForwardShouhuo();//独立测试窗口
    void action_BackShouhuo();//独立测试窗口
